...
- VictoriaMetrics health: https://obs-dev.proveai.com:8428/health
- Collector health: https://obs-dev.proveai.com:13133/health/status
...
curl https://obs-dev.proveai.com:8428/health
...
```bash
curl https://obs-dev.proveai.com:9090/-/ready
```

...
- vllm:external_prefix_cache_hits_created - External prefix cache hits from KV connector cross-instance cache sharing, in terms of number. 
...
- vllm:external_prefix_cache_queries_total - External prefix cache queries from KV connector cross-instance cache sharing, in terms of number. 
...
- vllm:external_prefix_cache_queries_created - External prefix cache queries from KV connector cross-instance cache sharing, in terms of number. 
- vllm:external_prefix_cache_hits_total - External prefix cache hits from KV connector cross-instance cache sharing, in terms of number. 

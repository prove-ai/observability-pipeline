...
**Disclaimer**: The visualizations and insights displayed in the dashboard are derived entirely from your connected external telemetry providers (e.g., Prometheus). Prove AI does not verify, modify, or guarantee the accuracy of this source data. Any discrepancies between your actual system performance and the dashboard visualizations should be investigated at the telemetry source. 
...
**Note on Accuracy**: All graphs and statistical distributions are subject to the polling intervals of your Prometheus server and network latency. These visualizations may not reflect instantaneous real-time model behavior and should be human-verified before taking operational actions.
...
**Integration Notice**: Creating an incident documents operational issues within the dashboard. Linking a GitHub or Jira repository does not grant Prove AI administrative access to your code or ticketing systems beyond the explicitly provided API scope.
